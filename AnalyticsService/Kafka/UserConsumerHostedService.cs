using AnalyticsService.Business;
...
namespace AnalyticsService.Kafka
{
	...
	{
		private readonly AnalyticsUserManager _userManager;

		public UserConsumerHostedService(
			IConfiguration configuration,
			AnalyticsUserManager userManager
			)
		{
				...
				try
				{
					...
					try
					{
						while (true)
						{
							...
							var appUser = JsonSerializer.Deserialize<AnalyticsUserProcessed>(consumer.Message.Value);
